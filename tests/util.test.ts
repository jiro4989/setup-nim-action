...
describe('function getLatestVersionWithTags', () => {
  ...
  const tests: TestPattern[] = [
    [
      ...
      '1.2.x',
      ['v1.0.3', 'v1.2.1', 'v1.2.2', 'v1.2.3', 'v1.20.3'],
      '1.2.3',
    ],
    [
    ...
    [
      ...
      '1.x',
      ['v1.1.1', 'v1.2.2', 'v1.3.3', 'v1.4.4-beta', 'v1.10.0'],
      '1.10.0',
    ],
    [
